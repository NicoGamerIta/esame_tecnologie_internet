...
import { Search } from '../components/Search_IT';
import { Cart } from '../components/Cart_IT';
    ...
    <main className={styles.main}>
      ...
      <nav className={styles.navbar}>
        ...
        <img src="/icon.png" alt="Site Logo" className={styles.logo} />
          ...
          <Link href="/it" className={`${styles.navLink} ${styles.active}`}>Home</Link>
            <Link href="/it/nuovo" className={styles.navLink}>Nuovi Arrivi</Link>
            <Link href="/it/uomo" className={styles.navLink}>Uomo</Link>
            <Link href="/it/donna" className={styles.navLink}>Donna</Link>
            <Link href="/it/contatti" className={styles.navLink}>Contatti</Link>
          </div>
          ...
          <Search />
            ...
            <Link href="/it/storico" className={styles.orderHistoryButton}>
      ...
      <section className={styles.hero}>
        <div className={styles.heroContent}>
          ...
          <p className={styles.heroSubtitle}>
            Abbigliamento autentico e tracciabile basato sulla tecnologia blockchain
          </p>
          <div className={styles.heroButtons}>
            <Link href="/new" className={`${styles.button} ${styles.primaryButton}`}>
              Esplora i Nuovi Arrivi
            </Link>
      ...
      <section className={styles.features}>
        <div className={styles.featuresContainer}>
          <div className={styles.feature}>
            ...
            <h3 className={styles.featureTitle}>Autenticità Garantita</h3>
            <p className={styles.featureDescription}>
              Ogni prodotto è autenticato tramite NFT sulla blockchain di Solana
            </p>
          </div>
          ...
          <div className={styles.feature}>
            ...
            <h3 className={styles.featureTitle}>Pagamenti Crypto</h3>
            <p className={styles.featureDescription}>
              Paga con USDT o USDC per transazioni veloci e sicure
            </p>
          </div>
          ...
          <div className={styles.feature}>
            ...
            <h3 className={styles.featureTitle}>Completa Tracciabilità</h3>
            <p className={styles.featureDescription}>
              Tieni traccia dell'origine e della storia di ogni capo
            </p>
          </div>
        </div>
      </section>
      ...
      <section className={styles.products}>
        <h2 className={styles.sectionTitle}>Nuovi Arrivi</h2>
        <div className={styles.productGrid}>
          {featuredProducts.map(product => (
            <div key={product.nft_address} className={styles.productCard}>
              <div className={styles.productImageContainer}>
              {product.image_url ? (
                <Link href={`/it/product/${product.nft_address}`}>
                <img
              ...
              <div className={styles.productNftBadge}>Verificato NFT</div>
            </div>
      ...
      <section className={styles.blockchainAdvantage}>
        <div className={styles.blockchainContainer}>
          <div className={styles.blockchainContent}>
            <h2 className={styles.blockchainTitle}>Vantaggi della Blockchain</h2>
            <p className={styles.blockchainDescription}>
              La nostra integrazione con Solana garantisce autenticità, sicurezza e trasparenza. 
              Ogni prodotto è collegato a un NFT univoco che ne certifica l'originalità.
            </p>
        ...
        <div className={styles.footerContainer}>
          <div className={styles.footerColumn}>
            ...
            <p className={styles.footerTagline}>
              Moda autentica alimentata dalla tecnologia blockchain
            </p>
          ...
          <div className={styles.footerNav}>
            <div className={styles.footerColumn}>
              ...
              <Link href="/new" className={styles.footerLink}>Nuovi Arrivi</Link>
              <Link href="/men" className={styles.footerLink}>Uomo</Link>
              <Link href="/women" className={styles.footerLink}>Donna</Link>
              <Link href="/sale" className={styles.footerLink}>Sconti</Link>
            </div>
            <div className={styles.footerColumn}>
              <h4 className={styles.footerTitle}>Informazioni</h4>
              ...
              <Link href="/sustainability" className={styles.footerLink}>Sostenibilità</Link>
              <Link href="/faq" className={styles.footerLink}>FAQ</Link>
            </div>
            <div className={styles.footerColumn}>
              <h4 className={styles.footerTitle}>Servizio Clienti</h4>
              <Link href="/contact" className={styles.footerLink}>Contattaci</Link>
              <Link href="/shipping" className={styles.footerLink}>Spedizioni e Rimborsi</Link>
              <Link href="/size-guide" className={styles.footerLink}>Guida alla Taglia</Link>
              <Link href="/support" className={styles.footerLink}>Supporto</Link>
            </div>
          </div>
        </div>

...
import { Product, getNewProducts } from '../../service/productService';
   ...
   const ProductCard = ({ product }: { product: Product }) => (
    <div className={styles.productCard}>
      <div className={styles.productImageContainer}>
        ...
        {product.quantity === 0 && <div className={styles.unavailableBadge}>Non Disponibile</div>}
      </div>
      <div className={styles.productInfo}>
        ...
        <div className={styles.productDetails}>
          ...
          <div className={styles.productAttributes}>
            <span className={styles.productSize}>Taglia: {product.size}</span>
            <span className={styles.productColor}>Colore: {product.color}</span>
          </div>
          <button 
          ...
          >
            {product.isAvailable ? 'Aggiungi al carrello' : 'Prodotto esaurito'}
          </button>
        </div>
      </div>
    </div>
    ...
    <main className={styles.main}>
      ...
      <nav className={styles.navbar}>
        <div className={styles.navbarContainer}>
          ...
          <div className={styles.navMenu}>
            <Link href="/it" className={styles.navLink}>Home</Link>
            <Link href="/it/nuovo" className={`${styles.navLink} ${styles.active}`}>Nuovi Arrivi</Link>
      ...
      <section className={styles.pageHeader}>
        <div className={styles.headerContent}>
          <h1 className={styles.pageTitle}>Nuovi Arrivi</h1>
          <p className={styles.pageDescription}>
            Scopri i nostri ultimi pezzi di moda autentici, ciascuno verificato con la tecnologia blockchain
          </p>
        </div>
      </section>
      ...
      <section className={styles.productsSection}>
        <div className={styles.productsContainer}>
          ...
          <div className={`${styles.filtersBar} ${filtersVisible ? styles.filtersVisible : ''}`}>
            ...
            <div className={styles.sortOptions}>
              <div className={styles.sortDropdown}>
                ...
                >
                  <option value="newest">Il più nuovo</option>
          ...
          {filtersVisible && (
            <div className={styles.filtersPanel}>
              <div className={styles.filterGroup}>
                <h4 className={styles.filterTitle}>Taglie</h4>
              ...
              <div className={styles.filterGroup}>
                <h4 className={styles.filterTitle}>Colori</h4>
                <div className={styles.filterOptions}>
                  {colors.map(color => (
              ...
              <div className={styles.filterGroup}>
                <h4 className={styles.filterTitle}>Range prezzo</h4>
          ...
          {/* Products Display */}
          {isLoading ? (
            <div className={styles.loadingIndicator}>Caricando i prodotti...</div>
          ) : (
            <>
              ...
              <div className={`${styles.productsGrid} ${viewMode === 'list' ? styles.listView : ''}`}>
                {filteredProducts.length > 0 ? (
                  ...
                  <div className={styles.noResults}>
                    <p>Nessun prodotto corrisponde ai tuoi filtri</p>
                    <button className={styles.clearFiltersButton} onClick={clearFilters}>
                      Cancella Tutti i Filtri
                    </button>
                  </div>

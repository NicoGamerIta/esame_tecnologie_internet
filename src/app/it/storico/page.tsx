    ...
    <div className={styles.ordersPage}>
      <div className={styles.ordersHeader}>
        <div className={styles.breadcrumbs}>
          <Link href="/it" className={styles.breadcrumbLink}>
            <Home size={16} />
            <span>Home</span>
          </Link>
          <span className={styles.breadcrumbSeparator}>/</span>
          <span className={styles.breadcrumbCurrent}>Miei Ordini</span>
        </div>
        ...
        <p className={styles.pageDescription}>
          Visualizza e traccia tutta la cronologia dei tuoi ordini
        </p>
      </div>
                  ...
                  <div className={styles.orderHeader}>
                    <div className={styles.orderInfo}>
                      <div className={styles.orderDate}>
                        <span className={styles.orderLabel}>Data di ordine:</span>
                        <span className={styles.orderValue}>{formatDate(order.creation_date)}</span>
                      </div>
                      {order.id_transaction && (
                        <div className={styles.transactionId}>
                          <span className={styles.orderLabel}>Transazione:</span>
      ...
      <div className={styles.ordersActions}>
        <Link href="/it" className={`${styles.button} ${styles.outlineButton}`}>
          <ChevronLeft size={16} />
          Torna allo Shopping
        </Link>
      </div>
